...
#Чесно?Я хз шо це, на каналі Django-School просто скопіював і поміняв назву змінних. Це все для того щоб можна було перематувати відео
def ranged(
        file: IO[bytes],
        start: int = 0,
        end: int = None,
...
def open_file(request, video_pk: int) -> tuple:
    _video = get_object_or_404(Messages, pk=video_pk)
